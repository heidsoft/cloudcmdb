...
public class GreenMailServer extends ExternalResource {
	...
	public static class Builder implements org.apache.commons.lang3.builder.Builder<GreenMailServer> {
		...
		public Builder withConfiguration(final ServerSetup configuration) {
		...
		public Builder withHooks(final Hooks hooks) {
			this.hooks = hooks;
			return this;
		}

		public Builder withUser(final String email, final String password) {
			this.users.add(new User(email, password));
			return this;
		}

		public Builder withUser(final String email, final String username, final String password) {
	...
	public GreenMailServer(final Builder builder) {
