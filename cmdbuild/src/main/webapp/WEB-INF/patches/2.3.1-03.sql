...
DECLARE
	...
	new_email_comment text := regexp_replace(email_comment, 'MODE: [^|]+', 'MODE: reserved');
	new_activity_email_comment text := regexp_replace(activity_email_comment, 'MODE: [^|]+', 'MODE: reserved');
BEGIN
