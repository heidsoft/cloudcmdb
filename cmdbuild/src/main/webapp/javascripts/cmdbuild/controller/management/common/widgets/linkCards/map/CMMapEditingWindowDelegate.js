(function(){
	...
	Ext.define("CMDBuild.controller.management.common.widgets.linkCards.map.CMMapEditingWindowDelegate", {
		extend: "CMDBuild.view.management.common.widgets.linkCards.map.CMMapEditingToolsWindowDelegate",
