(function() {
	 ...
	 * CMMapController.
	 */
	Ext.define("CMDBuild.controller.management.common.widgets.linkCards.map.CMCardBrowserDelegate", {
		extend: "CMDBuild.view.management.common.widgets.linkCards.map.CMCardBrowserTreeDelegate",
