Ext.define("CMDBuild.view.management.common.widgets.linkCards.cardWindow.CMFormWithWidgetButtons", {
	...
	initComponent: function() {
		...
		this.widgets = Ext.create('CMDBuild.view.management.common.widgets.linkCards.cardWindow.CMWidgetButtonsPanel', {
			region: 'east',
			hideMode: 'offsets',
