(function() {
	...
	Ext.define("CMDBuild.view.management.common.widgets.linkCards.map.CMCardBrowserTreeDelegate", {
		/**
		 *
		 * @param {CMDBuild.view.management.common.widgets.linkCards.map.CMCardBrowserTree} tree The tree who call the method
		...
		/**
		 * @param {CMDBuild.view.management.common.widgets.linkCards.map.CMCardBrowserTree} tree The activated panel
	...
	Ext.define("CMDBuild.view.management.common.widgets.linkCards.map.CMCardBrowserTree", {
		...
		constructor: function(ds) {
			this.mixins.delegable.constructor.call(this, "CMDBuild.view.management.common.widgets.linkCards.map.CMCardBrowserTreeDelegate");
