(function() {
	...
	Ext.define("CMDBuild.view.management.common.widgets.linkCards.map.CMMapPanelDelegate", {
		/**
		 *
		 * @param {CMDBuild.view.management.common.widgets.linkCards.map.CMMapPanel} mapPanel The map panel which has added the layer
		...
		/**
		 *
		 * @param {CMDBuild.view.management.common.widgets.linkCards.map.CMMapPanel} mapPanel The map panel which has removed the layer
		 * @param {Object} params Information about the layer
	...
	Ext.define("CMDBuild.view.management.common.widgets.linkCards.map.CMMapPanel", {
		...
		constructor: function() {
			this.mixins.delegable.constructor.call(this, "CMDBuild.view.management.common.widgets.linkCards.map.CMMapPanelDelegate");

			this.callParent(arguments);

			this.editingWindow = Ext.create('CMDBuild.view.management.common.widgets.linkCards.map.CMMapEditingToolsWindow', { owner: this });
		...
		initComponent: function() {
			...
			if (CMDBuild.configuration.gis.get('cardBrowserByDomainConfiguration')['root']) { // TODO: use proxy constants
				...
				this.cardBrowser = Ext.create('CMDBuild.view.management.common.widgets.linkCards.map.CMCardBrowserTree', {
			...
			this.layerSwitcher = Ext.create('CMDBuild.view.management.common.widgets.linkCards.map.CMMapLayerSwitcher', {
			...
			this.miniCardGrid = Ext.create('CMDBuild.view.management.common.widgets.linkCards.map.CMMiniCardGrid', {
