(function($) {
	var Lookup = function(param, onReadyFunction, onReadyScope) {
		/**
		 * Attributes
		 */
		this.param = param;
		...
		this.loadData = function(response, metadata) {
			$.Cmdbuild.utilities.proxy.getLookupData(this.type, {}, this.loadDataCallback, this);
		};
	...
	$.Cmdbuild.standard.backend.Lookup = Lookup;
}) (jQuery);
