...
public abstract class ForwardingAttribute extends ForwardingObject implements CMAttribute {

	/**
	 * Usable by subclasses only.
	 */
	protected ForwardingAttribute() {
	}

	@Override
	protected abstract CMAttribute delegate();
