...
public class CxfCardEmailsTest {
	...
	private CxfCardEmails underTest;
	...
	public void setUp() throws Exception {
		...
		underTest = new CxfCardEmails(errorHandler, dataAccessLogic, emailLogic, idGenerator);
	}
	...
	public void createFailsWhenInstanceIsNotFound() throws Exception {
		...
		doReturn(targetClass) //
				.when(dataAccessLogic).findClass(eq("dummy"));
		doThrow(new NoSuchElementException()) //
				.when(dataAccessLogic).fetchCard(eq("dummy"), eq(12L));
		doThrow(new WebApplicationException()) //
